...
class ExpresionAritmetica {
    ...
    public static Nodo MetodoSuma(Nodo aux, String n2, Nodo aux2, int cont) {
        String operacion = "";
        String resultado = "";
        String tipo = "";
        String tempVar = "t";
        ...
        if(aux.getValue() != null && aux2.getValue() != null){
            if (n2.equals("+")) {
                ...
                // Debemos averiguar si el valor es un id, función o simplemente un número
                    ...
                    if (Temporales.tempNum == 0) {
                        tempVar = tempVar + Temporales.tempNum + "";
                        Temporales.tempNum++;
    ...
    public static Nodo MetodoMultiplicacion(Nodo aux, String n2, Nodo aux2,int cont) {
        String operacion = "";
        String resultado = "";
        String tipo = "";
        String tempVar = "t";
